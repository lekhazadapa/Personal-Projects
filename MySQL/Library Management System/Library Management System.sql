...
-- Objectives:
-- 1. Building a database from scratch and constraints
-- 2. CRUD Opearations: Perform Create, Read, Update, and Delete
-- 3. CTAS (Create Table As Select): Utilizing CTAS to create a new tables based on query results
...
-- Adding constraints:
-- Foreign Key: Must be primary key in another table
-- Primary Key: Not null and Unique in that table
...
-- Rechecking the data from all the tables
...
-- Project Tasks:
-- Task 1. Insert the book details into the boooks table: "978-1-60129-456-2', 'To Kill a Mockingbird', 'Classic', 6.00, 'yes', 'Harper Lee', 'J.B. Lippincott & Co.')"
insert into books
